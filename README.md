...
Consolidated Cash Flow (CSCF)
Comparable Company Analysis (CCA)
Performed:
Financial statement analysis and forecasting
Sensitivity analysis on key assumptions (WACC, growth, inflation, tax)
Result:
Identified the stock as overvalued, with intrinsic value below market price
...
Valuation methods:
DCF, Dividend Discount Model (DDM), Comparable Company Analysis (CCA)
Key insight:
Highlighted high leverage and liquidity constraints, supporting a cautious investment stance


🔹 Capital Power Corp — Equity Valuation (Group Project)
Developed integrated valuation framework using:
DCF (50%), DDM (30%), CCA (20%)
Built detailed financial forecasts and assumptions by business segment
Performed sensitivity and scenario analysis
Result:
Estimated target price of ~CAD 78.41, indicating moderate upside potential
